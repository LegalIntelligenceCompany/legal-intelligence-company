...
export function LiveCreditsPanel(){
 ...
 return <section className="card team-panel"><p>Individual: 49 €/mês. Empresas: 99 €/mês, até três utilizadores com saldo partilhado. Acresce IVA quando aplicável.</p><p>As subscrições dão acesso; não incluem créditos de IA. Compra créditos separadamente e o chat desconta 3× o custo confirmado do fornecedor, convertido em euros. Não há carregamentos automáticos. Neste lançamento, os créditos financiam apenas a pesquisa do chat.</p>
