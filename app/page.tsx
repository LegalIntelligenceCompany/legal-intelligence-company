...
const services = [
  ...
  ["Biblioteca de cláusulas", "Guarde versões, notas de utilização e aprovação pessoal, sem chamadas à IA.", "/clauses", "Abrir biblioteca"],
  ["Anonimização e comparação", "Reveja dados pessoais e compare versões legislativas localmente, sem enviar textos para IA.", "/services", "Abrir ferramentas"],
  ["Todos os serviços", "Dossier de prova, reuniões, negociação, pesquisa documental, estudo e muito mais. IA paga desactivada nesta fase.", "/services", "Explorar serviços"],
