...
export default async function Launch(){
 ...
 return <AppShell><div className="eyebrow">Reservado ao titular</div><h1>Preparar o lançamento</h1>
  ...
  <section className="card team-panel"><h2>Próximo passo técnico: tarifas e consumo</h2><p>Se a estrutura da carteira está instalada, não repita o SQL. Consulte as tarifas de referência, simule a regra de 3× sem gastar créditos e veja o que ainda falta na contabilização.</p><Link href="/setup/tariffs" className="btn btn-primary">Preparar tarifas e consumo</Link></section>
